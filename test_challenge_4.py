...
def test_delete_valid_storage_id(test_user, run_shell_command, test_url):

    run_shell_command(f"python3 storetoise_3.py --username {test_user} --s 601 -m test")
...
def test_delete_valid_storage_id_short_names(test_user, run_shell_command):
    ...
    run_shell_command(f"python3 storetoise_3.py --username {test_user} --s 900 -m test")
